    ...
    <>
      ...
      <div className="navbar navbar-expand-md navbar-stuck-menu">
        <div className="container px-2">
          ...
          >
            <div className="w-100 d-md-none" style={{ textAlign: "right" }}>
              <button
            ...
            <ul className="navbar-nav mega-nav1 pr-md-2 pl-md-2 d-block d-xl-none">
              <li className="nav-item dropdown d-md-none">
                <Link className="nav-link dropdown-toggle pl-0" to="/product-list">
            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item dropdown">
                <Link className="nav-link dropdown-toggle fw-bold" to="/product-list">
                  Brand
                </Link>
              ...
              <li className="nav-item">
                <Link className="nav-link fw-bold" to="/discounted-products">
                  Discounted products
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link fw-bold" to="/stores">
                  Stores Near You
                </Link>
              </li>
              ...
              <li className="nav-item d-md-none">
                <Link className="dropdown-item" to="/sign-up">
                  <i className="fa fa-user-circle mr-2" /> Sign up
                </Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="category-menu">
              ...
              <li>
                ...
                <div className="mega_menu z-2">
                  <div className="mega_menu_inner">
                    <h6>
                      <Link to="/product-list">😻 Dry Food</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Wet Food</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Treats And Snacks</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Health & Vitamins</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Litter</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Litter Box</Link>
                    </h6>
                  </div>
                  <div className="mega_menu_inner">
                    <h6>
                      <Link to="/product-list">😻 NewBorn</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Sterilised Cats</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Toys & Activities</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Cleaning Tools</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Bed and House</Link>
                    </h6>
                  </div>
                  <div className="mega_menu_inner">
                    <h6>
                      <Link to="/product-list">😻 Leash & Collar</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Clothes</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Bowl & Feeder</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">😻 Accessories</Link>
                    </h6>
                  </div>
                </div>
              </li>
              ...
              <li>
                ...
                <div className="mega_menu z-2">
                  ...
                  <div className="mega_menu_inner">
                    ...
                    <h6>
                      <Link to="/product-list">🐶 Pad & Toilet</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">🐶 Toys & Activities</Link>
                    </h6>
              ...
              <li>
                ...
                <div className="mega_menu z-2">
                  <div className="mega_menu_inner">
                    <h6>
                      <Link to="/product-list">🐦 Bird Food</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">🐦 Toys & Supplements</Link>
                    </h6>
                    <h6>
                      <Link to="/product-list">🐦 Health & Vitamins</Link>
                    </h6>
              ...
              <li>
                ...
                <div className="mega_menu z-2">
                  <div className="mega_menu_inner">
                    <h6>
                      <Link to="/product-list">🐟 Food & Accessories</Link>
                    </h6>
                  </div>
                </div>
              </li>
...
//             <ul className="navbar-nav mega-nav1 pr-md-2 pl-md-2 d-block d-xl-none">
//               <li className="nav-item dropdown d-md-none">
//                 <a className="nav-link dropdown-toggle pl-0" href="#">
//                   <span style={{ marginLeft: "20px" }}>Categories</span>
//                 </a>
//                 <ul
//                   className="dropdown-menu __dropdown-menu-2"
...
//                     <ul className="dropdown-menu">
//                       <li>
//                         <a className="dropdown-item" href="/products?id=42">
//                           sub sub cat
//                         </a>
//                       </li>
//                     </ul>
